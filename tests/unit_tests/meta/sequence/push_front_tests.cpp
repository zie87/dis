...
UTEST(meta_sequence, push_front) {
    {
    ...
    }
    {
        ...
        ASSERT_TRUE((dis::meta::is_same_v<test_type, dis::meta::sequence<int, char>>));
    }
    {
        ...
        ASSERT_TRUE((dis::meta::is_same_v<test_type, dis::meta::sequence<int, char, int, short, double>>));
    }
}
