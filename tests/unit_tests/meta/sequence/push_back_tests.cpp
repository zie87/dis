...
TEST(meta_sequence_push_back) {
    ...
    }
    {
        ...
        UT_CHECK_TRUE((dis::meta::is_same_v<test_type, dis::meta::sequence<char, int>>));
    }
    {
        ...
        UT_CHECK_TRUE((dis::meta::is_same_v<test_type, dis::meta::sequence<int, short, double, char, int>>));
    }
}
